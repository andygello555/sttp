...
At this point the expression can be evaluated without the ambiguity of precedence or associativity. The expression can also be reconstructed into a tree during Shunting-Yard in the correct precedence heirarchy. This parse tree below the relevant \verb|exp| node could then be replaced by this new tree, and evaluated along with the entire tree.
...
% https://w3.cs.jmu.edu/lam2mo/cs432_2019_08/files/04-grammars.pdf
