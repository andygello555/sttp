...
\begin{figure}[H]
    ...
    \end{subfigure}
    \cprotect\caption{\label{fig:2.1}This produces the following graphs for the given input: \verb+aa|ba(e|c)+. \textit{Note that the }\verb|e|\textit{ represents $\epsilon$ (epsilon)}.}
\end{figure}
