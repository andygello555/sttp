...
func (e *Expression) right() []factor {
	f := make([]factor, len(e.Right))
...
func (p5t *Prec5Term) right() []factor {
	f := make([]factor, len(p5t.Right))
	for i, v := range p5t.Right {
		f[i] = v
	}
	return f
}
...
func (p4t *Prec4Term) right() []factor {
	f := make([]factor, len(p4t.Right))
	for i, v := range p4t.Right {
		f[i] = v
	}
	return f
}
...
func (p3t *Prec3Term) right() []factor {
	f := make([]factor, len(p3t.Right))
	for i, v := range p3t.Right {
		f[i] = v
	}
	return f
}
...
func (p2t *Prec2Term) right() []factor {
	f := make([]factor, len(p2t.Right))
	for i, v := range p2t.Right {
		f[i] = v
	}
	return f
}
...
func (p1t *Prec1Term) right() []factor {
	f := make([]factor, len(p1t.Right))
	for i, v := range p1t.Right {
		f[i] = v
	}
	return f
}
